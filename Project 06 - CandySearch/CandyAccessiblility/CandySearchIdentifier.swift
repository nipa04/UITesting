...
enum CandySearchIdentifier: String {
    case tableOfChocolateBar    = "Chocolate Bar"
    case tableOfChocolateChip   = "Chocolate Chip"
    case tableOfDarkChocolate   = "Dark Chocolate"
    case tableOfLollipop        = "Lollipop"
    case tableOfCandyCane       = "Candy cane"
    case tableOfJawBreaker      = "Jaw Breaker"
    case tableOfCaramel         = "Caramel"
    case tableOfSourChew        = "Sour Chew"
